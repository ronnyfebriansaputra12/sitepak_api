...
<div class="table-scrollable">
	<table class="table table-striped table-hover">
		<thead>
			<tr>
				<th style="background-color:#55cccc;" rowspan="5" colspan="1"><strong>NO</strong></th>
			...
			<tr>
				<td colspan="35">
					<div class="form-group">
						...
						<div class="col-md-1 text-center"><a href='<?php echo base_url()."resume/List_pengguna/excelResumeListPengguna?".$filterCari;?>' class="btn btn-success" target="_blank"><i class="fa fa-download"></i> Excel</a></div>
