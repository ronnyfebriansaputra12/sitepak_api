...
<div class="table-scrollable">
	<table class="table table-striped table-hover">
		...
		<tr>
			...
			<th width="10%"><strong>TOTAL PENGGUNA<br>TERDAFTAR</strong></th>
			<th width="10%"><strong>TOTAL TERDAFTAR<br>AKTIF</strong></th>
			<th width="10%"><strong>TOTAL AKTIF<br>SUDAH AKSES</strong></th>
			<th width="10%"><strong>TOTAL AKTIF<br>BELUM AKSES</strong></th>
			<th width="10%"><strong>TOTAL TERDAFTAR<br>TIDAK AKTIF</strong></th>
			<th width="10%"><strong>TOTAL TIDAK AKTIF<br>SUDAH AKSES</strong></th>
			<th width="10%"><strong>TOTAL TIDAK AKTIF<br>BELUM AKSES</strong></th>
		</tr>
	</thead>
		<tbody>
			...
			<tr>
				<td colspan="35">
					<div class="form-group">
						...
						<div class="col-md-1 text-center"><a href='<?php echo base_url()."resume/Resume_all/excelReportResume?".$filterCari;?>' class="btn btn-success" target="_blank"><i class="fa fa-download"></i> Excel</a></div>
