			...
			<tr>
				<td colspan="21">
					<div class="form-group">
						...
						<div class="col-md-1 text-center"><a href='<?php echo base_url()."laporan/Total_kuota/excelReport?".$filterCari;?>' class="btn btn-success" target="_blank"><i class="fa fa-download"></i> Excel</a></div>
