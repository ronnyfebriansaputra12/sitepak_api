						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" class="form-control input-sm mask-date_cari" id="CARI_ADM_TGL_ENTRY" name="CARI_ADM_TGL_ENTRY" placeholder="Kata Kunci" data-rule-required="true" data-msg-required="Bulan Wajib Diisi" data-rule-monthINA="true" data-msg-monthINA="Format Bulan Salah">
									</div>
								</div>
							</div>
							<div class="col-md-4">
