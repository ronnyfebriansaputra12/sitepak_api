			...
			<tr>
				<td colspan="10">
					<div class="form-group">
						<div class="col-md-1 text-center"><a href='<?php echo base_url()."laporan/Total_hak_akses/excelBulananGabungan/".$tanggal;?>' class="btn btn-success disabled" target="_blank"><i class="fa fa-download"></i> Excel</a></div>
