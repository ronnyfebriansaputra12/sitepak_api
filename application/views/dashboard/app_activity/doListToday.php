		...
		<div class="tabbable-custom">
			<div class="tab-content" id="permintaanCetak" style="padding:0">
				<div class="portlet-body form">
					<form class="form-horizontal" role="form" method="post" id="form_search-aktivitas_today" data-target='daftar_aktifitas_today_detil' action="<?=base_url().$this->router->fetch_directory().$this->router->fetch_class().'/'.$this->router->fetch_method().'Data' ?>">
						<div class="form-body">
				...
				<div class="portlet-body">
					<div class="table-responsive">
						<div id="daftar_aktifitas_today_detil"></div>
					</div>
				</div>
			</div>
		</div>
...
$(function(){
	$('#form_search-aktivitas_today').validate(option_form);
	...
	$("#Pencarian input[type='text']", "#form_search-aktivitas_today").attr('disabled',true);
	$("#Pencarian select", "#form_search-aktivitas_today").attr('disabled',true);
	$("#Pencarian input[type='checkbox']", "#form_search-aktivitas_today").change(function(e){
		if($(this).is(':checked')){
