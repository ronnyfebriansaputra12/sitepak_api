		...
		<div class="col-md-12">
			<div id="siak_list" class="col-md-12">
				<div class="portlet-body form">
				 <form action="<?=base_url().$this->router->fetch_directory().$this->router->fetch_class().'/doView02'?>" class="form-horizontal form_cari" id="form-cari-sinkronisasi_data" data-target='main_siak_child' method="post">
					<div class="form-body">
								...
								<div  class="col-md-2">
									<div class="input-group input-group-md" style="width:200px">
										<span class="input-group date date-picker">
											...
											<input name="DATE_PICKER" value="<?php echo date('m-Y');?>" id="DATE_PICKER" class="form-control" readonly="readonly" type="text">
										</span>
										<span class="input-group-btn">
