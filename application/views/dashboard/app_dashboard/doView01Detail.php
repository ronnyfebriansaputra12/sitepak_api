...
<table class="table table-striped table-hover">
	...
	<tbody>
		...
		foreach($listDataGroup as $row):
			...
			if($row->nama_kab == null){
				$namaKab='<i>LAPORAN DARI PROVINSI</i>';
			}else{
				$namaKab=$row->nama_kab;
			}
		?>
		
		<tr>
			<td align="center"><?php echo $i?></td>
			<td align="left"><?php echo $namaKab?></td>
	...
	<div class=" row col-md-12">
		...
		<a href='<?php echo base_url()."dashboard/app_dashboard/excelDashboard/".$row->no_prop.'/'.$tgl;?>' class="btn btn-success" target="_blank"><i class="fa fa-download"></i> Excel</a>
		</div>
		<div class="col-md-5">
