...
<div class="col-md-12">
	<h3 class="page-title" style="font-size:22px">
		<?php echo strtoupper($this->siakwordconvert->getIndonesiaMonth($bln_curr))." ".$thn_curr;?>	
	</h3>
<?
...
<table class="table table-striped table-hover">
	...
	<tbody>
		...
		<tr>
			...
			<td align="left"><a href="<?php echo base_url().$this->router->fetch_directory().$this->router->fetch_class().'/doView02Detail/'.$row->no_prop.'/'.$tgl;?>" data-hidden="siak_list" data-target="siak_edit" title="" data-placement="bottom" data-toggle="tooltip" class="ajaxify tooltips" style="text-decoration: none;"><?php echo $row->nama_prop?></a></td>
	...
	<div class=" row col-md-12">
		...
		<a href='<?php echo base_url()."dashboard/app_dashboard/excelDashboardPropBulanan/".$tgl;?>' class="btn btn-success" target="_blank"><i class="fa fa-download"></i> Excel</a>
		</div>
		<div class="col-md-5">
