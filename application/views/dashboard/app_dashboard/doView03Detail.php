...
<div class="form-actions form-group">                           
	<div class="row">
		...
		<div  class="col-md-2">
			<h3 class="page-title" style="font-size:22px;position: absolute;left: 100px;">
				TAHUN <?php echo $tgl;?>	
			</h3>				
		</div>
	</div>
...
<table class="table table-striped table-hover">
	<thead>
	   <tr>
		 <th style="width:2%"><strong>No</strong></th>
			...
			<th style="width:8%"><strong>TIDAK VALID</strong></th>
	...
	<tbody>
		...
		foreach($listDataGroup as $row):
			...
			$totTidakValid = $totTidakValid + $row->tidak_valid;
		...
		<tr>
			...
			<td align="right"><?php echo number_format($row->tidak_valid,0,",",".")?></td>
	...
	<tfoot>
		<tr>
			...
			<td align="right"><?php echo number_format($totTidakValid,0,",",".")?></td>
...
<div class=" row col-md-12">
		...
		<a href='<?php echo base_url()."dashboard/app_dashboard/excelDashboardTahunan/".$row->no_prop.'/'.$tgl;?>' class="btn btn-success" target="_blank"><i class="fa fa-download"></i> Excel</a>
		</div>
		<div class="col-md-5">
