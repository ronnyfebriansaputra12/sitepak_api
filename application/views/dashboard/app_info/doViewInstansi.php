<div class="panel-body">
	...
	?>
					...
					?>
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
							<div class="dashboard-stat grey-cascade" style="height:145px;">
								...
								<a href="<?php echo base_url().$this->router->fetch_directory().$this->router->fetch_class().'/doViewInfo/'.$inst['id_instansi'].'/'.$inst['id_category'].'/02';?>" class="ajaxify more" data-toggle="tooltip" data-placement="bottom" data-target="dashboard-container">
		...
		<div id="refreshdata-<?php echo $ID_KATEGORI;?>" data-url="<?php echo base_url().$this->router->fetch_directory().$this->router->fetch_class().'/data_refresh_kelompok?k='.$ID_KATEGORI.'&h='.$HARI.'&t='.(isset($delays) ? $delays: 15);?>" data-map='<?php echo json_encode($logcount);?>' data-noblock="true"></div>
