				...
				<div class="actions" style="margin-top:15px">
					<div class="btn-group pull-right">
						...
						<ul role="menu" class="dropdown-menu pull-right">
							<li>
								<a href="<?php echo base_url().$this->router->fetch_directory().$this->router->fetch_class().'/doView/01';?>" class="ajaxify" data-target="dashboard-container">
									</i>&nbsp; Daftar
								</a>
							</li>
							<li>
								<a href="<?php echo base_url().$this->router->fetch_directory().$this->router->fetch_class().'/doView/02';?>" class="ajaxify"  data-target="dashboard-container">
									&nbsp; Kelompok
								</a>
							</li>
						</ul>
