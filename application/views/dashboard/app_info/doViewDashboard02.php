			...
			<div class="panel panel-default" style="border:none;">
				<div class="panel-heading bg-white" style="border:none;">
					<h4 class="panel-title my-panel-title">
						<a href="#kategori-<?php echo $kat->id_table;?>" class="accordion-toggle" data-toggle="collapse" data-parent="instansi-kategori-list" data-href="<?php echo base_url().$this->router->fetch_directory().$this->router->fetch_class().'/doViewInstansiDashboard?ID_KATEGORI='.$kat->id_table.'&HARI='.$HARI;?>" style="text-decoration: none;">
							<?php echo $kat->category_name;?>
						</a>
					</h4>
				</div>
				<div id="kategori-<?php echo $kat->id_table;?>" class="panel-collapse in my-panel-collapse" data-href="<?php echo base_url().$this->router->fetch_directory().$this->router->fetch_class().'/doViewInstansiDashboard?ID_KATEGORI='.$kat->id_table.'&HARI='.$HARI;?>" style="border:none;"></div>
			</div>
		<?php
				endif;
			endforeach;
