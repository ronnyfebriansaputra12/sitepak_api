					<div class="row profile-account">
						<div class="col-md-3">
							<ul id="ul-dashboard-pengguna" class="ver-inline-menu tabbable margin-bottom-10">
								...
								<li>
									<a href="<?=base_url().$this->router->fetch_directory().$this->router->fetch_class().'/kata_kunci'?>" data-toggle="tab" data-target="#tab_info_pengguna-3">
										<i class="fa fa-lock"></i> Ganti Kata Kunci
									</a>
								</li>
								<li>
