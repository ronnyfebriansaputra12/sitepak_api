		...
		<div class="tabbable-custom">
			<div class="tab-content" id="permintaanCetak" style="padding:0">
				<div class="portlet-body form">
					<form class="form-horizontal" role="form" method="post" id="formSearch1" data-target='daftar_aktifitas_detil' action="<?=base_url().$this->router->fetch_directory().$this->router->fetch_class().'/'.$this->router->fetch_method().'Data' ?>">
						<div class="form-body">
										...
										<div class="col-md-6">
											<div class="form-group">
												<div class="col-md-4">
													<div align="left">
														<label>
															<input type="checkbox" class="cari_aktivitas" name="opsi_1" id="opsi_1">Alamat IP
														</label>
													</div>
												</div>
												<div class="col-md-7">
										...
										<div class="col-md-6">
											<div class="form-group">
												<div class="col-md-4">
													<div align="left">
														<label>
															<input type="checkbox" class="cari_aktivitas" name="opsi_2" id="opsi_2">Operasi
														</label>
													</div>
												</div>
												<div class="col-md-7">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<div class="col-md-4">
													<div align="left">
														<label><input type="checkbox" class="cari_aktivitas" name="opsi_3" id="opsi_3">Modul</label>
													</div>
												</div>
												<div class="col-md-7">
										...
										<div class="col-md-6">
											<div class="form-group">
												<div class="col-md-4">
													<div align="left">
														<label><input type="checkbox" class="cari_aktivitas" name="opsi_4" id="opsi_4">Tanggal</label>
													</div>
												</div>
												<div class="col-md-7">
													<input type="text" class="form-control input-sm mask-date_cari" id="CARI_TANGGAL" name="CARI_TANGGAL" placeholder="Kata Kunci">
												</div>
											</div>                                
										</div>
									</div>
				...
				<div class="portlet-body">
					<div class="table-responsive">
						<div id="daftar_aktifitas_detil"></div>
					</div>
				</div>
			</div>
		</div>
...
$(function(){
	$('#formSearch1').validate(option_form);
	...
	$("#Pencarian input[type='text']", "#formSearch1").attr('disabled',true);
	$("#Pencarian select", "#formSearch1").attr('disabled',true);
	$("#Pencarian input[type='checkbox']", "#formSearch1").change(function(e){
		if($(this).is(':checked')){
