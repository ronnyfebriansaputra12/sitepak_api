						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" class="form-control input-sm mask-date_cari" id="CARI[TGL_AWAL]" name="CARI[TGL_AWAL]" placeholder="Kata Kunci" data-rule-required="true" data-msg-required="Bulan Wajib Diisi" data-rule-monthINA="true" data-msg-monthINA="Format Bulan Benar">
									</div>
								</div>
							</div>
							<div class="col-md-4">
