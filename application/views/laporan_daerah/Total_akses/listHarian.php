<div id="siak_list" class="col-md-12">
	<div class="portlet box red">
		<div class="portlet-title">
			<div class="caption">DAFTAR LAPORAN TOTAL AKSES HARIAN (DAERAH)</div>
			<div class="actions">	
			</div>
		</div>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" class="form-control input-sm mask-date_cari" id="CARI[TGL_AWAL]" name="CARI[TGL_AWAL]" placeholder="Kata Kunci" data-rule-required="true" data-msg-required="Tanggal Wajib Diisi" data-rule-dateINA="true" data-msg-dateINA="Format Tanggal Benar">
									</div>
								</div>
							</div>
							<div class="col-md-4">
