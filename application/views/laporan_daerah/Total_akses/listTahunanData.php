			...
			<tr>
				<td colspan="10">
					<div class="form-group">
						...
						<div class="col-md-1 text-center"><a href='<?php echo base_url()."laporan_daerah/Total_akses/excelReportTahunan?".$filterCari;?>' class="btn btn-success" target="_blank"><i class="fa fa-download"></i> Excel</a></div>
