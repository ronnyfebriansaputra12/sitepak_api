			...
			<tr>
				<td colspan="10">
					<div class="form-group">
						<div class="col-md-1 text-center"><a href='<?php echo base_url()."laporan_daerah/Total_hak_akses/excelHarianGabungan/".$tanggal.'?kode_wilayah='.$kode_wilayah.'&prop='.$prop.'&kab='.$kab;?>' class="btn btn-success" target="_blank"><i class="fa fa-download"></i> Excel</a></div>
