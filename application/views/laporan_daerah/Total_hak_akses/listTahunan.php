						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" class="form-control input-sm mask-date_cari" id="CARI_ADM_TGL_ENTRY" name="CARI_ADM_TGL_ENTRY" placeholder="Kata Kunci" data-rule-required="true" data-msg-required="Tahun Wajib Diisi" data-rule-yearINA="true" data-msg-yearINA="Format Tahun Benar">
									</div>
								</div>
							</div>
							<div class="col-md-4">
