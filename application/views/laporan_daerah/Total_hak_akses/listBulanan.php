<div id="siak_list" class="col-md-12">
	<div class="portlet box red">
		<div class="portlet-title">
			<div class="caption">DAFTAR LAPORAN TOTAL AKSES BULANAN (DAERAH)</div>
			<div class="actions">	
			</div>
		</div>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-8">
											<? echo $this->widget_wilayah->get_propinsi(array('name'=>'tabel[NO_PROP]','param'=>'id="NO_PROP" class="form-control input-sm select2" '))?>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-8">
											<? echo $this->widget_wilayah->get_kabupaten(array('name'=>'tabel[NO_KAB]','param'=>'id="NO_KAB" class="form-control input-sm select2"'))?>
									</div>
								</div>
							</div>
							<div class="col-md-4">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" class="form-control input-sm mask-date_cari" id="CARI_ADM_TGL_ENTRY" name="CARI_ADM_TGL_ENTRY" placeholder="Kata Kunci" data-rule-required="true" data-msg-required="Bulan Wajib Diisi" data-rule-monthINA="true" data-msg-monthINA="Format Bulan Benar">
									</div>
								</div>
							</div>
							<div class="col-md-4">
