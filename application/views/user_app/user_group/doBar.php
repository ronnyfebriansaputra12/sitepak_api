	...
	<a href="<?=$this->router->fetch_directory().$this->router->fetch_class().'/doAdd'?>" class="ajaxify btn btn-circle btn-icon-only btn-default tooltips" data-toggle="tooltip" title="Tambah" data-target="topTab">
