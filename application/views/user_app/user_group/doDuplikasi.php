...
<div class="portlet box black">
  <div class="portlet-title">
	 <div class="caption">DUPLIKASI KELOMPOK PENGGUNA</div>
  </div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						  ...
						  <div class="col-md-4">
							<?php echo form_dropdown('X1_GROUP_LEVEL',$cb_group_level,$data[0]->group_level,'class="form-control input-sm" id="X1_GROUP_LEVEL"  readonly="readonly"')?>
						  </div>
					</div>
				</div>
			</div>  
