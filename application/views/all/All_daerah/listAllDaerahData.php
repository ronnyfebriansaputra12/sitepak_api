...
<div class="table-scrollable">
	<table class="table table-striped table-hover">
		<thead>
			<tr>
				<th style="background-color:#99ffcc" rowspan="5"><strong>NO</strong></th>
				<th style="background-color:#55ddcc;" rowspan="5" colspan="1"><strong>NAMA WILAYAH</strong></th>
				<th style="background-color:#00ff99;" rowspan="5" colspan="1"><strong>NAMA LEMBAGA</strong></th>
				...
				<th style="background-color:#ff1a1a;" rowspan="3" colspan="9"><strong>TOTAL AKSES</strong></th>
			...
			<tr>
				...
				<th style="background-color:#ff6666;" colspan="4"><strong>WEB SERVICE</strong></th>
				<th style="background-color:#ff6666;" rowspan="2" colspan="1"><strong>WEB PORTAL</strong></th>
				<th style="background-color:#ff6666;" colspan="3"><strong>BIOMETRIK</strong></th>
				<th style="background-color:#ff6666;" rowspan="2" colspan="1"><strong>TOTAL KESELURUHAN</strong></th>
			</tr>
			...
			<tr>
				...
				<th style="background-color:#ff6666;"><strong>WS LAMA</strong></th>
				<th style="background-color:#ff6666;"><strong>WS KESESUAIAN</strong></th>
				<th style="background-color:#ff6666;"><strong>WS KOMBINASI</strong></th>
				<th style="background-color:#ff6666;"><strong>TOTAL</strong></th>
				<th style="background-color:#ff6666;"><strong>FINGER PRINT</strong></th>
				<th style="background-color:#ff6666;"><strong>FACE RECOGNITION</strong></th>
				<th style="background-color:#ff6666;"><strong>TOTAL</strong></th>
			</tr>
		</thead>
		<tbody>
			...
			<tr>
			  ...
			  <td align="right"><?php echo number_format($row->ta_wsl,0,",",".")?></?></td>
			  <td align="right"><?php echo number_format($row->ta_wskes,0,",",".")?></?></td>
			  <td align="right"><?php echo number_format($row->ta_wskom,0,",",".")?></?></td>
			  <td align="right"><?php echo number_format($row->ta_ws_all,0,",",".")?></?></td>
			  <td align="right"><?php echo number_format($row->ta_wp_all,0,",",".")?></?></td>
			  <td align="right"><?php echo number_format($row->ta_fp,0,",",".")?></?></td>
			  <td align="right"><?php echo number_format($row->ta_fr,0,",",".")?></?></td>
			...
			<tr>
				<td colspan="39">
					<div class="form-group">
						...
						<div class="col-md-1 text-center"><a href='<?php echo base_url()."all/All_daerah/excelReportAll?".$filterCari;?>' class="btn btn-success" target="_blank"><i class="fa fa-download"></i> Excel</a></div>
