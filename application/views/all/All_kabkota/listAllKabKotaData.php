...
<div class="table-scrollable">
	<table class="table table-striped table-hover">
		...
		<tbody>
			...
			?>
			<tr>
			  <?php if($row->nama_wilayah == $row->nama_pengguna && $row->no_kab == 0){ ?>
			  
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->no_urut?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->kode_wilayah?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->nama_pengguna?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->ws_stat_aktivasi?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->wp_stat_aktivasi?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->bio_stat_aktivasi?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->ws_akses_data?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->wp_akses_data?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->bio_akses_data?></b></td>
			  
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->ws_user_aktif?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->ws_kuota_aktif?></b></td>
			  
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->ws_user_nonaktif?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->ws_kuota_nonaktif?></b></td>
			  
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->wp_ua_aktif?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->wp_ka_aktif?></b></td>
			  
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->wp_ua_nonaktif?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->wp_ka_nonaktif?></b></td>
			  
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->wp_uo_aktif?></b></td>
			  
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->wp_uo_nonaktif?></b></td>
			  
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->bio_user_aktif?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->bio_kuota_aktif?></b></td>
			  
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->bio_user_nonaktif?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->bio_kuota_nonaktif?></b></td>
			  
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->ma_wsl?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->ma_wskes?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->ma_wskom?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->ma_fp?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->ma_fr?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->ma_wp?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->ta_ws_all?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->ta_wp_all?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->ta_bio_all?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->ta_all?></b></td>
			  <td align="center" style="background-color:#ffff66;"><b><?php echo $row->status_akses?></b></td>
			  
			  <?php }elseif($row->nama_wilayah == $row->nama_pengguna && $row->no_kab != 0){ ?>
			...
			<tr>
				<td colspan="36">
					<div class="form-group">
						...
						<div class="col-md-1 text-center"><a href='<?php echo base_url()."all/All_kabkota/excelReportAllKabKota?".$filterCari;?>' class="btn btn-success" target="_blank"><i class="fa fa-download"></i> Excel</a></div>
